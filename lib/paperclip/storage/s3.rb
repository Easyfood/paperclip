  ...
  module Storage
    ...
    module S3
      def self.extended base
        ...
        if Gem::Version.new(Aws::CORE_GEM_VERSION) >= Gem::Version.new(2) &&
           Gem::Version.new(Aws::CORE_GEM_VERSION) <= Gem::Version.new("2.0.33")
        ...
        base.instance_eval do
          ...
          if @options.has_key?(:use_accelerate_endpoint) &&
              Gem::Version.new(Aws::CORE_GEM_VERSION) < Gem::Version.new("2.3.0")
